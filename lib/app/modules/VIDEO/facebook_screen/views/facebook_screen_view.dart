        ...
        body: ConstantWidgets.backgroundTemplate(
            ...
            rightWidget: Row(
              children: [
                InkWell(
                    onTap: () {
                      Get.to(FacebookInstagramInfoScreenView(), arguments: 'Facebook');
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  Text('Facebook Video Download', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w600),),
                  SizedBox(height: 24.sp),
                  Container(
                    height: 26.sp,
                    width: width * 0.82,
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: TextButton(
                                                      ...
                                                      child: Text('OK', style: TextStyle(color: ConstantsColor.themeColor),)
                                                  ),
                                                )
                                              ],
                                            )
